...
/**
 * @param {AST.ConflictClause} onConflict
 ...
 * @param {AST._SelectFromClause} from
...
/**
 * @param {AST.TableOrSubquery | null} query
 * @return {AST._SelectFromClause}
 */
...
/**
 * @param {AST.ConflictClause} conflict
...
/**
 * @param {[AST.IndexedColumn, ...AST.IndexedColumn[]]} indexedColumns
 * @param {null | AST.ConflictClause} conflict
 ...
 * @param {'DELETE' | 'INSERT' | AST._UpdateClause} event
 * @param {string} tableName
...
/**
 * @param {null | string | AST._ReindexNameClause} target
