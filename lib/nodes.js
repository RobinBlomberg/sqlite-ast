...
/**
 * @param {AST._Identifier} bindParameter
...
/**
 * @param {AST._Identifier} functionName
 * @param {AST.Expr[] | '*'} args
...
/**
 * @param {AST._Identifier | null} object
...
/**
 * @param {null | AST._Identifier} from
 ...
 * @param {AST._Identifier} tableAlias
...
/**
 * @param {AST._Identifier} aggregateFunc
...
/**
 * @param {null | AST._Identifier} name
...
/**
 * @param {AST._Identifier} columnName
 * @param {AST._Identifier | null} typeName
 ...
 * @param {'DELETE' | 'INSERT' | AST._Identifier[]} event
 * @param {AST._Identifier} tableName
...
/**
 * @param {AST._NumericLiteral | AST._Identifier} value
...
/**
 * @param {AST._Path} path
 * @param {null | AST._Identifier} alias
...
/**
 * @param {['ROLLBACK' | 'ABORT' | 'FAIL', AST._Identifier] | null} onError
...
/**
 * @param {null | AST._Identifier | AST._Path} target
...
/**
 * @param {AST._ColumnAliasClause | AST._Identifier} source
...
/**
 * @param {AST._Identifier} simpleFunc
 * @param {AST.Expr[] | '*'} args
...
/**
 * @param {null | AST._Identifier} path
...
/**
 * @param {[AST._Identifier, ...AST._Identifier[]]} names
...
/**
 * @param {null | AST._Identifier} schemaName
 * @param {null | AST._Identifier} filename
...
/**
 * @param {null | AST._Identifier} baseWindowName
...
/**
 * @param {AST._Identifier} windowFunc
 * @param {AST.Expr[] | '*'} expr
 * @param {null | AST.FilterClause} filter
 * @param {AST.WindowDefn | AST._Identifier} over
