 ...
 * @return {AST._ArrayExpression}
 */
export const _ArrayExpression = (expressions) => {
  return {
 ...
 */
export const _BinaryKeywordExpression = (
  left,
  negated,
  operator,
  right,
 ...
 * @param {AST._WhereClause | null} where
...
/**
 * @param {AST.Expr} expr
 * @return {AST._WhereClause}
 */
export const _WhereClause = (expr) => {
  return {
    type: '_WhereClause',
    expr,
  };
 ...
 */
export const CreateVirtualTableStmt = (
  ifNotExists,
  path,
  moduleName,
  moduleArguments,
 ...
 * @param {AST.QualifiedTableName} name
 * @param {[AST._SetClause, ...AST._SetClause[]]} set
 * @param {[AST.TableOrSubquery, ...AST.TableOrSubquery[]] | AST.JoinClause | null} from
 * @param {AST._WhereClause | null} where
 * @param {AST._LimiterClause | null} limiter
