...
declare function _AddClause(columnDef: AST.ColumnDef): AST._AddClause;
...
declare function _BlobLiteral(value: string[]): AST._BlobLiteral;
...
declare function _CaseClause(when: AST.Expr, then: AST.Expr): AST._CaseClause;
...
declare function _CheckClause(expr: AST.Expr): AST._CheckClause;

declare function _CheckConstraint(check: AST.Expr): AST._CheckConstraint;
...
declare function _DefaultClause(expr: AST.Expr): AST._DefaultClause;
...
declare function _Identifier(name: string): AST._Identifier;
...
declare function _JoinOnClause(on: AST.Expr): AST._JoinOnClause;
...
declare function _MatchClause(name: AST._Identifier): AST._MatchClause;
...
declare function _NumericLiteral(value: number): AST._NumericLiteral;
...
declare function _PragmaGetter(value: AST.PragmaValue): AST._PragmaGetter;

declare function _PragmaSetter(value: AST.PragmaValue): AST._PragmaSetter;
...
declare function _StringLiteral(value: string): AST._StringLiteral;
...
declare function _WhereClause(expr: AST.Expr): Ast._WhereClause;
...
declare function DetachStmt(schemaName: AST._Identifier): AST.DetachStmt;
...
declare function FilterClause(where: AST._WhereClause): AST.FilterClause;
...
declare function ReleaseStmt(savepointName: AST._Identifier): AST.ReleaseStmt;
...
declare function SqlStmt(statement: AST._Stmt): AST.SqlStmt;
...
declare function UpdateStmt(
  ...
  name: AST.QualifiedTableName,
  set: [AST._SetClause, ...AST._SetClause[]],
  from: [AST.TableOrSubquery, ...AST.TableOrSubquery[]] | AST.JoinClause | null,
  where: AST._WhereClause | null,
  limiter: AST._LimiterClause | null,
): AST.UpdateStmt;
